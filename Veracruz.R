...
attach(ConcVeracruz) #this is for not writing the name of the data frame and the $ ever time

#Sort Conc according to INGCOR, FOLIOVIV, FOLIOHOG
ConcVeracruz<- orderBy (~+ing_cor+folioviv+foliohog, data=ConcVeracruz) #this give us the households sorted by total income

#Adding the values of the expansion FACTOR. The sum is 34 million, which is the number of households in the country.
tot_hogares<-sum(ConcVeracruz$factor,to.data.frame=TRUE)
...
ConcVeracruz$tam_dec<-tam_dec

# Creating Deciles of Income 

ConcVeracruz$MAXT<-ConcVeracruz$ing_cor #vamos a crear en esta base la variable MAXT que es una copia de la columna de ingresos

ConcVeracruz<-ConcVeracruz[with(ConcVeracruz, order(rank(MAXT))),]  #lo que hicimos aqu? fue reordenar la base con respecto a MAXT. Cosa que en realidad, ya estaba.

ConcVeracruz$ACUMULA<-cumsum(ConcVeracruz$factor) #aqu? creamos una variable de suma acumulada del FACTOR de viviendas.
...
for(i in 1:9)
{
  a1<-ConcVeracruz[dim(ConcVeracruz[ConcVeracruz$ACUMULA<tam_dec*i,])[1]+1,]$factor
  ConcVeracruz<-rbind(ConcVeracruz[1:(dim(ConcVeracruz[ConcVeracruz$ACUMULA<tam_dec*i,])[1]+1),],
                      ConcVeracruz[(dim(ConcVeracruz[ConcVeracruz$ACUMULA<tam_dec*i,])[1]+1):dim(ConcVeracruz[1])[1],])
  
  b1<-tam_dec*i-ConcVeracruz[dim(ConcVeracruz[ConcVeracruz$ACUMULA<tam_dec*i,])[1],]$ACUMULA
  ConcVeracruz[(dim(ConcVeracruz[ConcVeracruz$ACUMULA<tam_dec*i,])[1]+1),]$factor<-b1
  ConcVeracruz[(dim(ConcVeracruz[ConcVeracruz$ACUMULA<tam_dec*i,])[1]+2),]$factor<-(a1-b1)
}

#aqu? estamos creando otra variable de suma acumulada del n?mero de hogares
ConcVeracruz$ACUMULA2<-cumsum(ConcVeracruz$factor)

#aqu? estamos creando una variable que se llama decil que solo tiene ceros
ConcVeracruz$DECIL<-0
...
ConcVeracruz[(ConcVeracruz$ACUMULA2<=tam_dec),]$DECIL<-1
...
for(i in 1:9)
{
  ConcVeracruz[((ConcVeracruz$ACUMULA2>tam_dec*i)&(ConcVeracruz$ACUMULA2<=tam_dec*(i+1))),]$DECIL<-(i+1)
}

# a lo que le qued? cero (que es la ?ltima observaci?n), ponle el decil 10
ConcVeracruz[ConcVeracruz$DECIL%in%"0",]$DECIL<-10

setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Veracruz")
write.dbf(ConcVeracruz,file="ConcVeracruz2010.dbf")
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Veracruz")
write.dbf(ConcVeracruz,file="ConcVeracruz2018.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Veracruz")
Conc2010<-read.dbf("ConcVeracruz2010.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Veracruz por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Veracruz por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Veracruz por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Veracruz por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Veracruz por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Veracruz INDIGENA por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Veracruz INDIGENA por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Veracruz INDIGENA por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Veracruz INDIGENA por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Veracruz INDIGENA por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Veracruz NO por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Veracruz NO por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Veracruz NO por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Veracruz NO por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Veracruz NO por fuente por DECIL LS 2010.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Veracruz")
Conc2018<-read.dbf("ConcVeracruz2018.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Veracruz Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Veracruz Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Veracruz Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Veracruz Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Veracruz Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Veracruz INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Veracruz INDIGENA Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Veracruz INDIGENA Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Veracruz INDIGENA Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Veracruz INDIGENA Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Veracruz NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Veracruz NO Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Veracruz NO Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Veracruz NO Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Veracruz NO Ingresos por fuente por DECIL LS 2018.dbf")
...
Deciles2010<-read.dbf("Veracruz por fuente por DECIL estimaciones 2010.dbf")
names(Deciles2010)[1]<-c("ingcor2010")

Deciles2018<-read.dbf("Veracruz Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010No<-read.dbf("Veracruz NO por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010No)[1]<-c("No2010")

deciles2018No<-read.dbf("Veracruz NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010indigena<-read.dbf("Veracruz INDIGENA por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010indigena)[1]<-c("Indigena2010")

deciles2018indigena<-read.dbf("Veracruz INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
